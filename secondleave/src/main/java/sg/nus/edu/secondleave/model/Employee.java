...
public class Employee {
	...
	public Employee(String name, String username, String password, Set<Role> roles, Collection<LeaveApplication> leaves,
			Collection<LeaveEntitlement> leaveEntitlements) {
		super();
		this.name = name;
